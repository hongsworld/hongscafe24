...
#define WITH_MODULES
#endif
#define LIBXSLT_DEFAULT_PLUGINS_PATH() "/user/hongs/.rvm/gems/ruby-1.9.3-p545/gems/nokogiri-1.6.1/ports/x86_64-redhat-linux/libxslt/1.1.26/lib/libxslt-plugins"
#endif
