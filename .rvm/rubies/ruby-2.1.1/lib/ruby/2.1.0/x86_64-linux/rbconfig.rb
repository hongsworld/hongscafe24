...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/user/hongs/.rvm/rubies/ruby-2.1.1")
  ...
  CONFIG["configure_args"] = " '--prefix=/user/hongs/.rvm/rubies/ruby-2.1.1' '--disable-install-doc' '--enable-shared'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/user/hongs/.rvm/rubies/ruby-2.1.1"
