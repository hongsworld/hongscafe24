...
//div.head 로드 -> HTML에 그대로 넣음. 
/*
$("#body").ready( function () {
          $('div[template-include]').each(function() {
            $(this).load($(this).attr('template-include') + '.html').trigger('create');
          });
});
*/
...
//          script.src = "js/" + location.pathname.split('/').slice(-1)[0].slice(0,-5) + ".js";
//          $("head").append(script);
//jquerymobile js 로드      
//          var jquerymobile = document.createElement('script');
//          jquerymobile.type = "text/javascript";
//          jquerymobile.src = "js/jquerymobile-1.4.1.js"
//          $("head").append(jquerymobile);

    $(document).ready(function(){
//calc 안되는거 적용
        //function tab(){
          $(".profile").css("margin-left","12.5%").css("margin-left","-=46.375px").css("margin-right","12.5%").css("margin-right","-=46.375px");
          $(".profile.tappable-active").css("margin-left","12.5%").css("margin-left","-=46.375px").css("margin-right","12.5%").css("margin-right","-=46.375px");
          $(".newquest").css("margin-left","12.5%").css("margin-left","-=46.375px").css("margin-right","12.5%").css("margin-right","-=46.375px");
          $(".newquest.tappable-active").css("margin-left","12.5%").css("margin-left","-=46.375px").css("margin-right","12.5%").css("margin-right","-=46.375px");
          $(".ongoingquest").css("margin-left","12.5%").css("margin-left","-=46.375px").css("margin-right","12.5%").css("margin-right","-=46.375px");
          $(".ongoingquest.tappable-active").css("margin-left","12.5%").css("margin-left","-=46.375px").css("margin-right","12.5%").css("margin-right","-=46.375px");
          $(".history").css("margin-left","12.5%").css("margin-left","-=46.375px").css("margin-right","12.5%").css("margin-right","-=46.375px");
          $(".history.tappable-active").css("margin-left","12.5%").css("margin-left","-=46.375px").css("margin-right","12.5%").css("margin-right","-=46.375px");
          var height100 = $(window).height();
          $("div.body").css("minHeight",height100 - 262);
        //}
      //tappable적용
          tappable('.profile', function(){
              location.href= "../detailProfile.html"
          });

          tappable('.newquest', function(){
              location.href= "../listNewQuest.html"
          });

          tappable('.ongoingquest', function(){
              location.href= "../listOngoingQuest.html"
          });

          tappable('.history', function(){
              location.href= "../listHistory.html"
          });
      //
