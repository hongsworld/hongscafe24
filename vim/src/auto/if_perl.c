...
XS(XS_VIM_Msg); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIM_Msg)
{
    dXSARGS;
    if (items < 1 || items > 2)
	Perl_croak(aTHX_ "Usage: VIM::Msg(text, hl=NULL)");
    SP -= items;
    {
	char *	text = (char *)SvPV_nolen(ST(0));
	char *	hl;
#line 1024 "if_perl.xs"
    int		attr;
    int		id;
...
XS(XS_VIM_SetOption); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIM_SetOption)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: VIM::SetOption(line)");
    SP -= items;
    {
	char *	line = (char *)SvPV_nolen(ST(0));
#line 1045 "if_perl.xs"
    if (line != NULL)
...
XS(XS_VIM_DoCommand); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIM_DoCommand)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: VIM::DoCommand(line)");
    SP -= items;
    {
	char *	line = (char *)SvPV_nolen(ST(0));
#line 1054 "if_perl.xs"
    if (line != NULL)
...
XS(XS_VIM_Eval); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIM_Eval)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: VIM::Eval(str)");
    SP -= items;
    {
	char *	str = (char *)SvPV_nolen(ST(0));
#line 1062 "if_perl.xs"
	char_u *value;
#line 1118 "if_perl.c"
...
XS(XS_VIM_Buffers); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIM_Buffers)
{
    dXSARGS;
...
XS(XS_VIM_Windows); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIM_Windows)
{
    dXSARGS;
   PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
#line 1132 "if_perl.xs"
    win_T   *vimwin;
    int	    i, w;

#line 1212 "if_perl.c"
#line 1136 "if_perl.xs"
    if (items == 0)
    {
	if (GIMME == G_SCALAR)
...
XS(XS_VIWIN_DESTROY); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIWIN_DESTROY)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: VIWIN::DESTROY(win)");
    {
	VIWIN	win;
...
XS(XS_VIWIN_Buffer); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIWIN_Buffer)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: VIWIN::Buffer(win)");
    {
	VIWIN	win;
	SV *	RETVAL;
...
XS(XS_VIWIN_SetHeight); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIWIN_SetHeight)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: VIWIN::SetHeight(win, height)");
    SP -= items;
    {
	VIWIN	win;
	int	height = (int)SvIV(ST(1));
#line 1184 "if_perl.xs"
    win_T *savewin;
...
XS(XS_VIWIN_Cursor); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIWIN_Cursor)
{
    dXSARGS;
    if (items < 1)
	Perl_croak(aTHX_ "Usage: VIWIN::Cursor(win, ...)");
    SP -= items;
    {
	VIWIN	win;
...
XS(XS_VIBUF_DESTROY); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIBUF_DESTROY)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: VIBUF::DESTROY(vimbuf)");
    {
	VIBUF	vimbuf;
...
XS(XS_VIBUF_Name); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIBUF_Name)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: VIBUF::Name(vimbuf)");
    SP -= items;
    {
	VIBUF	vimbuf;
...
XS(XS_VIBUF_Number); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIBUF_Number)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: VIBUF::Number(vimbuf)");
    SP -= items;
    {
	VIBUF	vimbuf;
...
XS(XS_VIBUF_Count); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIBUF_Count)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: VIBUF::Count(vimbuf)");
    SP -= items;
    {
	VIBUF	vimbuf;
...
XS(XS_VIBUF_Get); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIBUF_Get)
{
    dXSARGS;
    if (items < 1)
	Perl_croak(aTHX_ "Usage: VIBUF::Get(vimbuf, ...)");
    SP -= items;
    {
	VIBUF	vimbuf;
#line 1267 "if_perl.xs"
    char_u *line;
    int i;
    long lnum;
#line 1511 "if_perl.c"
...
XS(XS_VIBUF_Set); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIBUF_Set)
{
    dXSARGS;
    if (items < 1)
	Perl_croak(aTHX_ "Usage: VIBUF::Set(vimbuf, ...)");
    SP -= items;
    {
	VIBUF	vimbuf;
#line 1289 "if_perl.xs"
    int i;
    long lnum;
    char *line;
#line 1554 "if_perl.c"
...
XS(XS_VIBUF_Delete); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIBUF_Delete)
{
    dXSARGS;
    if (items < 1)
	Perl_croak(aTHX_ "Usage: VIBUF::Delete(vimbuf, ...)");
    SP -= items;
    {
	VIBUF	vimbuf;
#line 1327 "if_perl.xs"
...
XS(XS_VIBUF_Append); /* prototype to pass -Wmissing-prototypes */
XS(XS_VIBUF_Append)
{
    dXSARGS;
    if (items < 1)
	Perl_croak(aTHX_ "Usage: VIBUF::Append(vimbuf, ...)");
    SP -= items;
    {
	VIBUF	vimbuf;
#line 1381 "if_perl.xs"
    int		i;
    long	lnum;
    char	*line;
#line 1688 "if_perl.c"
...
extern "C"
#endif
XS(boot_VIM); /* prototype to pass -Wmissing-prototypes */
XS(boot_VIM)
{
    dXSARGS;
    char* file = __FILE__;
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXSproto("VIM::Msg", XS_VIM_Msg, file, "$;$");
        newXSproto("VIM::SetOption", XS_VIM_SetOption, file, "$");
        newXSproto("VIM::DoCommand", XS_VIM_DoCommand, file, "$");
        newXSproto("VIM::Eval", XS_VIM_Eval, file, "$");
        newXSproto("VIM::Buffers", XS_VIM_Buffers, file, ";@");
        newXSproto("VIM::Windows", XS_VIM_Windows, file, ";@");
        newXSproto("VIWIN::DESTROY", XS_VIWIN_DESTROY, file, "$");
        newXSproto("VIWIN::Buffer", XS_VIWIN_Buffer, file, "$");
        newXSproto("VIWIN::SetHeight", XS_VIWIN_SetHeight, file, "$$");
        newXSproto("VIWIN::Cursor", XS_VIWIN_Cursor, file, "$;@");
        newXSproto("VIBUF::DESTROY", XS_VIBUF_DESTROY, file, "$");
        newXSproto("VIBUF::Name", XS_VIBUF_Name, file, "$");
        newXSproto("VIBUF::Number", XS_VIBUF_Number, file, "$");
        newXSproto("VIBUF::Count", XS_VIBUF_Count, file, "$");
        newXSproto("VIBUF::Get", XS_VIBUF_Get, file, "$;@");
        newXSproto("VIBUF::Set", XS_VIBUF_Set, file, "$;@");
        newXSproto("VIBUF::Delete", XS_VIBUF_Delete, file, "$;@");
        newXSproto("VIBUF::Append", XS_VIBUF_Append, file, "$;@");
    XSRETURN_YES;
}
